  ...
  transform: translateX(7px);
    ...
    <body class="antialiased font-sans">
        <div class="background-container">
            <img id="background" src="https://images.pexels.com/photos/167699/pexels-photo-167699.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1" />
        </div>
            <div class="relative min-h-screen flex flex-col items-center justify-center selection:bg-[#FF2D20] selection:text-white">
                <div class="relative w-full max-w-2xl px-6 lg:max-w-7xl">
                    <header class="grid items-center py-10">
                        ...
                        <div id="btn" class="flex justify-center mt-4">
